...
namespace bloom_filters {
	...
	public:
		...
		template <typename _T, 
				...
				typename _Block, 
				class _Allocator>
		friend bool operator==(const twohash_dynamic_counting_bloom_filter<_T, 
																			_BitsPerBin,
																			_HashValues,
																			...
																			_Block,
																			_Allocator>& lhs,
							const twohash_dynamic_counting_bloom_filter<_T, 
																		_BitsPerBin,
																		_HashValues,
																		_ExpectedInsertionCount,
																		_HashFn1,
	...
	template<class T, 
			...
			typename Block,
			class Allocator>
	void swap(twohash_dynamic_counting_bloom_filter<T, 
													BitsPerBin,
													HashValues,
													ExpectedInsertionCount,
													HashFunction1,
													...
													Block,
													Allocator>& lhs,
				twohash_dynamic_counting_bloom_filter<T, 
													BitsPerBin,
													HashValues,
													ExpectedInsertionCount,
													HashFunction1,
	...
	template<class T, 
			...
			typename Block,
			class Allocator>
    bool operator==(const twohash_dynamic_counting_bloom_filter<T, 
																BitsPerBin,
																HashValues,
																ExpectedInsertionCount,
																HashFunction1,
																...
																Block,
																Allocator>& lhs,
					const twohash_dynamic_counting_bloom_filter<T, 
																BitsPerBin,
																HashValues,
																ExpectedInsertionCount,
																HashFunction1,
