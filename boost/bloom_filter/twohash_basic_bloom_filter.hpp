...
namespace bloom_filters {
    ...
    public:
		...
		twohash_basic_bloom_filter(const InputIterator start, const InputIterator end)
		{
		...
		friend bool operator==(const twohash_basic_bloom_filter<_T, 
																_Size,
																_HashValues, 
    ...
    bool operator==(const twohash_basic_bloom_filter<T, 
													Size, 
													HashValues,
													ExpectedInsertionCount,
													HashFunction1,
