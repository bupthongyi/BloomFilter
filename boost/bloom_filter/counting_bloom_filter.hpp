...
namespace bloom_filters {
	...
	public:
		...
		typedef counting_bloom_filter<T, 
									NumBins, 
									BitsPerBin, 
									HashFunctions, 
									Block> this_type;
	...
	public:
		...
		template <typename _T, 
				...
				typename _HashFns, 
				typename _Block>
		friend bool operator==(const counting_bloom_filter<_T, _Bins, _BitsPerBin, _HashFns, _Block>& lhs,
    ...
    template<class T, size_t NumBins, size_t BitsPerBin, class HashFunctions,typename Block>
    void swap(counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& lhs,
    ...
    template<class T, size_t NumBins, size_t BitsPerBin, class HashFunctions,typename Block>
    bool operator==(const counting_bloom_filter<T, NumBins, BitsPerBin, HashFunctions, Block>& lhs,
