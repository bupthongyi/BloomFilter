...
namespace bloom_filters {
	...
	public:
		...
		typedef dynamic_counting_bloom_filter<T, 
											BitsPerBin, 
											HashFunctions, 
	...
	public:
		...
		dynamic_counting_bloom_filter(const InputIterator start, const InputIterator end) 
		...
		template <typename _T, 
				...
				typename _Block, 
				typename _Allocator>
		friend bool operator==(const dynamic_counting_bloom_filter<_T, 
																	_BitsPerBin,
																	_HashFns, 
																	_Block,
																	_Allocator>& lhs,
								const dynamic_counting_bloom_filter<_T, 
																	_BitsPerBin,
																	_HashFns, 
																	_Block,
																	_Allocator>& rhs);
	...
	template<class T, size_t BitsPerBin, class HashFunctions, typename Block, typename Allocator>
	void swap(dynamic_counting_bloom_filter<T, 
											BitsPerBin, 
											HashFunctions, 
											Block,
											Allocator>& lhs,
				dynamic_counting_bloom_filter<T, 
											BitsPerBin,
											HashFunctions, 
											Block,
											Allocator>& rhs)
    ...
    template<class T, size_t BitsPerBin, class HashFunctions, typename Block, typename Allocator>
    bool operator==(const dynamic_counting_bloom_filter<T, 
														BitsPerBin, 
														HashFunctions, 
														Block,
														Allocator>& lhs,
					const dynamic_counting_bloom_filter<T, 
														BitsPerBin,
														HashFunctions, 
														Block,
														Allocator>& rhs)
