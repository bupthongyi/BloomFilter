...
namespace bloom_filters {
	...
	public:
		...
		typedef twohash_counting_bloom_filter<T, 
											NumBins, 
											BitsPerBin, 
											HashValues,
	...
	public:
		...
		twohash_counting_bloom_filter(const InputIterator start, const InputIterator end) 
		{
			this->clear();
	...
	template <typename T, 
			...
			typename Block>
	void swap(twohash_counting_bloom_filter<T, 
											NumBins, 
											BitsPerBin, 
											HashValues,
											ExpectedInsertionCount,
											...
											ExtensionFunction, 
											Block>& lhs,
				twohash_counting_bloom_filter<T, 
											NumBins, 
											BitsPerBin, 
											HashValues,
											ExpectedInsertionCount,
	...
	template <typename T, 
			...
			class ExtensionFunction, 
			typename Block>
    bool operator==(const twohash_counting_bloom_filter<T, 
														NumBins, 
														BitsPerBin, 
														HashValues,
														ExpectedInsertionCount,
														...
														ExtensionFunction, 
														Block>& lhs,
					const twohash_counting_bloom_filter<T, 
														NumBins, 
														BitsPerBin, 
														HashValues,
														ExpectedInsertionCount,
